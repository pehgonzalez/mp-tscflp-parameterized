...
flows in both directions at equal cost after a trimming step that turns
the inequalities \eqref{eq:C1} and~\eqref{eq:C2} into equalities at no
extra cost. Total unimodularity of the
