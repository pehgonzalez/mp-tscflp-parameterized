...
Proposition~\ref{prop:oracle} in Appendix~\ref{app:proofs}. Under
...
Appendix~\ref{app:proofs}, lowers flows at no
...
the proof of Proposition~\ref{prop:oracle} in Appendix~\ref{app:proofs}, until each product's total
