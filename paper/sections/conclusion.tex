...
emerges has two layers. The covering layer is structural and strong,
and it fires wherever a facility side tells the members of a dimension
apart through a $\{0,1\}$ cost matrix, with tight capacities supplying
the fourth and least obvious such pair. The numeric layer is what
remains where no pair fires, and outside the fourth pair its hardness
is weak and dissolves under a unary encoding.
...
non-metric uncapacitated facility location problem \citep{Hochbaum1982} as the
