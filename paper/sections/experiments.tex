...
Xeon processor at $2.1$~GHz. The budget boundary sample of Q1 ran on a
second such machine with an Intel Xeon at $2.8$~GHz.
...
the tenfold budget of $600$~s, on the second virtual machine documented
above. The two samples therefore support the solved-versus-censored
contrast across budgets and time readings within one budget, and no
cross-budget time comparison is drawn. Medians are taken over solved runs only, so the times in
...
$n=24$, and none solves from $n=28$ upward, so that budget places the
border at $n\approx 24$, for this implementation, under this protocol,
in plain optimisation mode. Under $600$~s both $n=20$ and $n=24$ solve
...
falling from $13.7$~s at $k^\ast=4$ to $0.6$~s at $k^\ast=16$ under
