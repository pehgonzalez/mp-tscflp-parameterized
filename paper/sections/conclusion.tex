...
exists. The second asks whether the parameter $k$ lies in $\mathrm
...
beyond this model. The third asks for the unary status of $\{|J|,|L|\}$ and
...
fourth asks whether a polynomial kernel exists in the full parameter
...
kernelization. The fifth asks how transport costs that are structured
...
five-product groups. The log analysis traces that association to the
tightness of the root relaxation, so on this benchmark the bound
annotates relaxation tightness rather than search difficulty.
