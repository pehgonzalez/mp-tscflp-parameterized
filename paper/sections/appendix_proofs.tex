...
fires instead line 3 reports the same infinite optimum. In every mode
the returned $\OPT_k$ equals $\mathrm{best}$, so the run with
$B=+\infty$ reads the optimum off either branch.
\end{proof}
