...
and its practical residue is an a priori bound that annotates an instance
...
cost columns (Proposition~\ref{prop:ftcompress}). The obstruction over the
incidence representation we analyse is arithmetic rather
