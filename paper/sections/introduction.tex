...
The gadgets were validated by a shared battery of on the order of nine
hundred thousand individual checks with no failure, and the enumeration algorithm agrees
